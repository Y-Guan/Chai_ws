...
(cl:defmethod cl:initialize-instance :after ((m <demo_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chai-msg:<demo_msg> is deprecated: use chai-msg:demo_msg instead.")))

(cl:ensure-generic-function 'greeting-val :lambda-list '(m))
(cl:defmethod greeting-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chai-msg:greeting-val is deprecated.  Use chai-msg:greeting instead.")
  (greeting m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chai-msg:number-val is deprecated.  Use chai-msg:number instead.")
  (number m))
